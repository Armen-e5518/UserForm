...
$this->registerJsFile('/admin/js/jquery/jquery-3.1.1.js');
$this->registerJsFile('/admin/js/jquery/jquery.dataTables.min.js', ['position' => \yii\web\View::POS_END]);
$this->registerJsFile('/admin/js/form-data-table.js', ['position' => \yii\web\View::POS_END]);
